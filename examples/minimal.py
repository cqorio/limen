...
# Rate limiting is opt-in: add RateLimit buckets to your own registry (see examples/observability.py).
...
for i in range(25):
    limen.record(RequestContext(method="GET", path=f"/api/reports/{i}", status=404, ip="6.6.6.6"))
